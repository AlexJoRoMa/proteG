...
export default function ProductCard({color, borderColor, icon, altIcon, cardData}: GenericProductComponentProps) {
    ...
    return (
        ...
        <Card className='xl:w-full max-w-[402px] lg:max-w-[264px] xl:max-w-[284px] 3xl:max-w-[344px] 4xl:max-w-[384px] bg-white border border-solid' style={{borderColor: `${borderColor}`}}>
            <CardHeader className='flex w-full h-[144px] mt-0' style={{background: `${color}`}}>
            ...
            <CardFooter>
                <div className='flex flex-col w-full'>
                    <Button as={Link} className="w-[90%] bg-color-trasparent h-[48px] border-[1px] border-solid rounded-md text-[18px] lg:text-[16px] xl:mx-[16px] 3xl:text-[18px] mx-[20px] mb-[16px]"
