...
const PriceComponent = ({textBeforePrice, textAfterPrice, price, align='vertical'}: PriceComponentProps) => {
  return (
    <>
    <div className={`flex ${align === 'vertical' ? 'justify-start' : align === 'horizontal' ? 'md:h-0 md:relative md:bottom-[90px] xl:bottom-[100px] md:-mb-[38px] md:justify-end' : 'justify-start'} items-baseline flex-wrap`}>
